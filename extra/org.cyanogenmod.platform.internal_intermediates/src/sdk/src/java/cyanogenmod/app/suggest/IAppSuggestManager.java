 ...
 * Original file: vendor/cmsdk/sdk/src/java/cyanogenmod/app/suggest/IAppSuggestManager.aidl
 */
package cyanogenmod.app.suggest;
/**
 * @hide
 */
public interface IAppSuggestManager extends android.os.IInterface
{
/** No-Op implementation  */
/** @hide */
public static class NoOp implements cyanogenmod.app.suggest.IAppSuggestManager
{
...
public static abstract class Stub extends android.os.Binder implements cyanogenmod.app.suggest.IAppSuggestManager
{
private static final java.lang.String DESCRIPTOR = "cyanogenmod.app.suggest.IAppSuggestManager";
...
/**
 * Cast an IBinder object into an cyanogenmod.app.suggest.IAppSuggestManager interface,
 * generating a proxy if needed.
 */
public static cyanogenmod.app.suggest.IAppSuggestManager asInterface(android.os.IBinder obj)
{
if ((obj==null)) {
return null;
}
android.os.IInterface iin = obj.queryLocalInterface(DESCRIPTOR);
if (((iin!=null)&&(iin instanceof cyanogenmod.app.suggest.IAppSuggestManager))) {
return ((cyanogenmod.app.suggest.IAppSuggestManager)iin);
}
return new cyanogenmod.app.suggest.IAppSuggestManager.Stub.Proxy(obj);
}
@Override public android.os.IBinder asBinder()
{
return this;
...
private static class Proxy implements cyanogenmod.app.suggest.IAppSuggestManager
{
