 ...
 * Original file: vendor/cmsdk/sdk/src/java/cyanogenmod/app/ILiveLockScreenManager.aidl
 */
package cyanogenmod.app;
/** @hide */
public interface ILiveLockScreenManager extends android.os.IInterface
{
/** No-Op implementation  */
/** @hide */
public static class NoOp implements cyanogenmod.app.ILiveLockScreenManager
{
...
/**
     ...
     */
@Override public cyanogenmod.app.LiveLockScreenInfo getDefaultLiveLockScreen() throws android.os.RemoteException
{
return null;
}
/**
     ...
     * when no other Live lock screens are queued.
     */
@Override public void setDefaultLiveLockScreen(cyanogenmod.app.LiveLockScreenInfo llsInfo) throws android.os.RemoteException
{
}
/**
     * Set whether Live lock screen feature is enabled.
     */
@Override public void setLiveLockScreenEnabled(boolean enabled) throws android.os.RemoteException
{
}
/**
...
public static abstract class Stub extends android.os.Binder implements cyanogenmod.app.ILiveLockScreenManager
{
private static final java.lang.String DESCRIPTOR = "cyanogenmod.app.ILiveLockScreenManager";
...
/**
 * Cast an IBinder object into an cyanogenmod.app.ILiveLockScreenManager interface,
 * generating a proxy if needed.
 */
public static cyanogenmod.app.ILiveLockScreenManager asInterface(android.os.IBinder obj)
{
if ((obj==null)) {
return null;
}
android.os.IInterface iin = obj.queryLocalInterface(DESCRIPTOR);
if (((iin!=null)&&(iin instanceof cyanogenmod.app.ILiveLockScreenManager))) {
return ((cyanogenmod.app.ILiveLockScreenManager)iin);
}
return new cyanogenmod.app.ILiveLockScreenManager.Stub.Proxy(obj);
}
@Override public android.os.IBinder asBinder()
{
return this;
...
case TRANSACTION_cancelLiveLockScreen_1:
{
data.enforceInterface(DESCRIPTOR);
java.lang.String _arg0;
_arg0 = data.readString();
...
case TRANSACTION_getDefaultLiveLockScreen_3:
{
data.enforceInterface(DESCRIPTOR);
cyanogenmod.app.LiveLockScreenInfo _result = this.getDefaultLiveLockScreen();
reply.writeNoException();
if ((_result!=null)) {
reply.writeInt(1);
_result.writeToParcel(reply, android.os.Parcelable.PARCELABLE_WRITE_RETURN_VALUE);
...
case TRANSACTION_setDefaultLiveLockScreen_4:
{
data.enforceInterface(DESCRIPTOR);
...
this.setDefaultLiveLockScreen(_arg0);
reply.writeNoException();
return true;
}
case TRANSACTION_setLiveLockScreenEnabled:
{
data.enforceInterface(DESCRIPTOR);
boolean _arg0;
_arg0 = (0!=data.readInt());
this.setLiveLockScreenEnabled(_arg0);
return true;
}
...
case TRANSACTION_registerChangeListener_7:
{
data.enforceInterface(DESCRIPTOR);
...
private static class Proxy implements cyanogenmod.app.ILiveLockScreenManager
{
...
_data.writeInt(id);
_data.writeInt(userId);
mRemote.transact(Stub.TRANSACTION_cancelLiveLockScreen_1, _data, _reply, 0);
_reply.readException();
}
finally {
_reply.recycle();
...
try {
_data.writeInterfaceToken(DESCRIPTOR);
mRemote.transact(Stub.TRANSACTION_getDefaultLiveLockScreen_3, _data, _reply, 0);
_reply.readException();
if ((0!=_reply.readInt())) {
_result = cyanogenmod.app.LiveLockScreenInfo.CREATOR.createFromParcel(_reply);
}
...
mRemote.transact(Stub.TRANSACTION_setDefaultLiveLockScreen_4, _data, _reply, 0);
_reply.readException();
}
finally {
_reply.recycle();
...
mRemote.transact(Stub.TRANSACTION_setLiveLockScreenEnabled, _data, null, android.os.IBinder.FLAG_ONEWAY);
}
finally {
_data.recycle();
}
...
mRemote.transact(Stub.TRANSACTION_registerChangeListener_7, _data, _reply, 0);
_reply.readException();
_result = (0!=_reply.readInt());
}
finally {
...
static final int TRANSACTION_cancelLiveLockScreen_1 = (android.os.IBinder.FIRST_CALL_TRANSACTION + 1);
static final int TRANSACTION_getCurrentLiveLockScreen = (android.os.IBinder.FIRST_CALL_TRANSACTION + 2);
static final int TRANSACTION_getDefaultLiveLockScreen_3 = (android.os.IBinder.FIRST_CALL_TRANSACTION + 3);
static final int TRANSACTION_setDefaultLiveLockScreen_4 = (android.os.IBinder.FIRST_CALL_TRANSACTION + 4);
static final int TRANSACTION_setLiveLockScreenEnabled = (android.os.IBinder.FIRST_CALL_TRANSACTION + 5);
static final int TRANSACTION_getLiveLockScreenEnabled = (android.os.IBinder.FIRST_CALL_TRANSACTION + 6);
static final int TRANSACTION_registerChangeListener_7 = (android.os.IBinder.FIRST_CALL_TRANSACTION + 7);
static final int TRANSACTION_unregisterChangeListener = (android.os.IBinder.FIRST_CALL_TRANSACTION + 8);
}
/**
     * Enqueue a Live lock screen to be displayed.
     */
...
/**
     ...
     * when no other Live lock screens are queued.
     */
public cyanogenmod.app.LiveLockScreenInfo getDefaultLiveLockScreen() throws android.os.RemoteException;
/**
     * Set the default Live lock screen.  This is the Live lock screen that should be displayed
     * when no other Live lock screens are queued.
     */
public void setDefaultLiveLockScreen(cyanogenmod.app.LiveLockScreenInfo llsInfo) throws android.os.RemoteException;
/**
     * Set whether Live lock screen feature is enabled.
     */
public void setLiveLockScreenEnabled(boolean enabled) throws android.os.RemoteException;
/**
     * Get the enabled state of the Live lock screen feature.
     */
